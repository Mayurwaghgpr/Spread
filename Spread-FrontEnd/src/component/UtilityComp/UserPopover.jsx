    ...
    >
      <div className=" flex flex-row justify-between items-center font-medium ">
        ...
        <Follow
          People={people}
          className={
            "relative  p-1 py-2  transition-all text-xs max-w-[5rem] w-full  duration-200 bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-full"
          }
        />
      </div>
