  ...
  return (
    ...
    >
      <div
        ...
        className="relative bg-[#f3efeb] dark:bg-black border-s border-inherit flex flex-col gap-2  sm:animate-slide-in-right  animate-slide-in-bottom w-[30rem] rounded-md  sm:h-full h-[80%] "
      >
        <h1 className="text-xl p-4">Comments</h1>
        <CommentInput
          className={
            "fixed bg-[#f3efeb] border-t border-black dark:bg-black bottom-0 z-10 flex justify-start items-start gap-5  w-full animate-slide-in-top  p-5  dark:border-inherit"
          }
        />
