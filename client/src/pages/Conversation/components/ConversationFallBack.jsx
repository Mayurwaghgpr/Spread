...
function ConversationFallBack() {
  ...
  return (
    <div className="flex flex-col justify-center items-start gap-3 w-[80%] p-32 pt-0 h-full ">
      <h1 className="text-3xl font-bold text-oplight ">
      ...
      <button
        className="px-4 py-2 dark:bg-white bg-oplight text-white dark:text-black rounded-full hover:opacity-80 transition-all duration-300"
