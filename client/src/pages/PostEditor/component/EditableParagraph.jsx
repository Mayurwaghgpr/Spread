  ...
  if (index === 0 || index === 1) {
    return (
      <div ref={containerRef} className="w-full h-full relative border-inherit">
        ...
        <input
          className={`border-l-2 rounded-lg border-inherit bg-inherit dark:bg-inherit border-gray-300 dark:border-white p-2 w-full min-h-10 z-10 dark:placeholder:text-white placeholder:text-black placeholder:opacity-50 outline-none cursor-text ${index === 0 ? "text-4xl" : "text-2xl"}`}
