...
const ReadList = () => {
  ...
  return (
    <section className="relative flex flex-col justify-start items-start w-full h-screen xl:items-center dark:*:border-[#383838] bg-light dark:bg-dark  overflow-y-auto">
