...
function Suggetions() {
  ...
  return (
    <section className="grid grid-cols-10 grid-rows-12  w-full h-screen overflow-y-auto ">
      <div className=" sticky top-16 flex flex-col justify-between items-start col-start-3 col-span-5 row-start-2 row-span-2 py-3 w-full h-full z-10 border-b bg-[#fff9f3] dark:bg-black ">
